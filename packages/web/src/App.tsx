...
const HomePageContent: React.FC = () => {
  ...
  return (
    <div className="min-h-dvh bg-gradient-to-br from-purple-600 to-blue-500 flex items-center justify-center p-8">
      <div className="text-center text-white max-w-4xl w-full">
        <h1 className="text-6xl font-bold mb-4">啊呣啊呣</h1>
